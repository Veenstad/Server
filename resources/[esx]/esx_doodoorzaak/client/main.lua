  ...
  function Start(ped)
	  ...
	  while checking do
		  ...
		  if distance < 2.0 then
			  DrawText3D(x,y,z, 'Druk [~g~E~s~] om te onderzoeken', 0.4)
  ...
  function Notification(x,y,z)
	  ...
	  while (timestamp + 4500) > GetGameTimer() do
		  Citizen.Wait(0)
		  DrawText3D(x, y, z, 'De schade lijkt hier te gebeuren', 0.4)
		  checking = false
	  end
  end
  ...
  function OpenDeathMenu(player)
	  ...
	  table.insert(elements, {label = 'Probeer doodsoorzaak te achterhalen', value = 'deathcause'})
	  table.insert(elements, {label = 'Probeer te identificeren waar de schade is opgetreden', value = 'damage'})
	  ...
	  function(data, menu)
		  ...
		  if ac == 'damage' then
			  ...
			  if success then
				  ...
				  Notify('Waar de schade is opgetreden kon niet worden geïdentificeerd')
			  end
		  end
