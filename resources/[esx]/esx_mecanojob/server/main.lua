...
RegisterServerEvent('esx_mecanojob:startHarvest4')
AddEventHandler('esx_mecanojob:startHarvest4', function()
  local _source = source
...
AddEventHandler('esx_mecanojob:onNPCJobMissionCompleted', function()
  ...
  local bedrijf = total * 0.40
  local persoon = total * 0.60
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'society_mecano', function(account)
    account.addMoney(bedrijf)
  end)

  xPlayer.addMoney(persoon)

  TriggerClientEvent("esx:showNotification", _source, _U('your_comp_earned').. bedrijf)
  TriggerClientEvent("esx:showNotification", _source, _U('your_earned').. persoon)
