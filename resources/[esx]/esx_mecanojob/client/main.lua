        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            local elements = {
              ...
              {label = _U('tow_truck'), value = 'towtruck'},
			        ...
			        {label = _U('rebel'), value = 'rebel'},
              {label = _U('bodhi2'), value = 'bodhi2'},
              {label = "Bison", value = 'rass'},
            }
      ...
      if data.current.value == 'cloakroom2' then
			...
			if data.current.value == 'cloakroom' then
				...
				ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
					...
					if skin.sex == 0 or 1 then
					local model = GetHashKey("s_m_y_construct_02")
  ...
  if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name ~= 'recrue' then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'jerrycan' then
          menu.close()
          TriggerServerEvent('esx_mecanojob:startHarvest4')
        end
...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustReleased(0, Keys['X']) and not IsDead and PlayerData.job ~= nil and PlayerData.job.name == 'mecano' then
