...
function OpenShopCenter()
	...
	ESX.UI.Menu.CloseAll()
  	...
  	local elements = {}
		...
		if showblip then
			table.insert(elements, {label = 'Laat geen winkels op de map zien', value = 'removeblip'})
		else
			table.insert(elements, {label = 'Laat alle winkels op de map zien', value = 'showblip'})
		end
...
function OpenBoss()
  ...
  ESX.TriggerServerCallback('esx_kr_shop:getOwnedShop', function(data)
	...
	local elements = {}
		...
		table.insert(elements, {label = 'Je hebt: €' .. data[1].money .. ' in je bedrijf',    value = ''})
		table.insert(elements, {label = 'Zendingen',    value = 'shipments'})
        table.insert(elements, {label = 'Verkoop product', value = 'putitem'})
        table.insert(elements, {label = 'Haal product uit de verkoop',    value = 'takeitem'})
        table.insert(elements, {label = 'Plaats geld in je winkelkluis',    value = 'putmoney'})
        table.insert(elements, {label = 'Neem geld uit je winkelkluis',    value = 'takemoney'})
        table.insert(elements, {label = 'Verander bedrijfsnaam: €' .. Config.ChangeNamePrice,    value = 'changename'})
		table.insert(elements, {label = 'Verkoop bedrijf voor €' .. math.floor(data[1].ShopValue / Config.SellValue),   value = 'sell'})
        ...
        elseif data.current.value == 'takemoney' then
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'Neem geld', {
                title = 'Hoeveel geld wil je uit je kluis halen?'
            }, function(data2, menu2)
		...
		menu2.close()
	 	...
	 	elseif data.current.value == 'putmoney' then
			...
			title = 'Hoeveel wil je in je kluis stoppen?'
	  ...
	  elseif data.current.value == 'changename' then
		...
		ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'changename', {
		  title = 'Hoe wil je je winkel noemen?'
...
function OpenShipments(id)
	...
	table.insert(elements, {label = 'Producten bestellen', value = 'buy'})
	table.insert(elements, {label = 'Distributie', value = 'shipments'})
...
function GetAllShipments(id)
	...
	local once2 = true
		...
		for i=1, #items, 1 do
			...
			table.insert(elements, {label = '--Ontvangen distributie--'})
			table.insert(elements, {label = 'Ontvang alle distributie', value = 'pickup'})
			once2 = false
			end
			...
			if time - items[i].time <= Config.DeliveryTime and once then
				table.insert(elements, {label = '--Distributie onderweg--'})
				once = false
			end
  ...
  function(data, menu)
        ...
        local invcount = data.current.count
			...
			if count > invcount then
				ESX.ShowNotification('~r~Je kan niet meer verkopen dan je hebt!')
				menu2.close()
				menu.close()
			else
				menu2.close()
...
function createForSaleBlips()
	if showblip then
		...
		IDBLIPS = {
			...
			[16] = {x = 1763.34,   y = 2546.86,   z = 45.57,   n = 16},
			...
			[21] = {x = 461.74,    y = -709.29,   z = 27.37,   n = 21},
			[22] = {x = 538.14,    y = 101.09,    z = 96.51,   n = 22},
			[23] = {x = 194.34,    y = -993.14,   z = 30.09,   n = 23},
			[24] = {x = 198.59,    y = -956.75,   z = 30.09,   n = 24},
			[25] = {x = 151.46,    y = -968.62,   z = 30.09,   n = 25},
			[26] = {x = -164.57,   y = -1439.22,  z = 31.41,   n = 26},
			[27] = {x = 386.17,    y = -325.93,   z = 46.87,   n = 27},
			[28] = {x = 51.02,     y = -135.44,   z = 55.2,    n = 28},
			[29] = {x = -359.13,   y = -129.35,   z = 38.7,    n = 29},
			[30] = {x = 316.74,    y = -588.61,   z = 53.29,   n = 30},
			[31] = {x = 436.52,    y = -985.98,   z = 30.69,   n = 31},
			[32] = {x = 97.83,     y = 284.18,    z = 109.98,  n = 32},
			[33] = {x = -1223.25,  y = -906.75,   z = 12.33,   n = 33},
		}
...
function Robbery(id)
	...
	local coords1 = {
		...
		[5] = {x = 1395.49, y = 3612.94, z = 34.98, heading = 22.18},
		[6] = {x = -2959.5, y = 386.78, z =14.04 , heading = 171.58},
		[7] = {x = 2674.36, y = 3288.0, z = 55.24, heading = 339.44},
		[8] = {x = -42.76, y = -1749.36, z = 29.42, heading = 320.15},
		[9] = {x = 1160.77, y = -313.04, z = 69.21, heading = 10.81},
		[10] = {x = -708.14, y = -903.45, z =19.22 , heading = 5.29},
		[11] = {x = -1828.23, y = 800.33, z = 138.16, heading = 53.63},
		[12] = {x = 1707.87, y = 4919.26, z = 42.06, heading = 237.41},
		[13] = {x = 1961.75, y = 3749.27, z = 32.34, heading = 304.34},
		[14] = {x = 1126.26, y = -980.14, z = 45.42, heading = 9.13},
		[15] = {x = 30.45, y = -1339.88, z = 29.5 , heading = 269.79},
		[17] = {x = 543.77, y = 2663.47, z = 42.16, heading = 96.45},
		[18] = {x = -3249.02, y = 1007.04, z = 12.83, heading = 0.76},
		[19] = {x = 1168.51, y = 2718.37, z = 37.16, heading = 271.45},
		[20] = {x = 1736.66, y = 6419.02, z = 35.04, heading = 247.6},
		[21] = {x = 465.75, y = -709.46, z = 27.53, heading = 266.78},
		[22] = {x = 550.29, y = 122.6, z = 98.04, heading = 160.16},
		[26] = {x = -152.0, y = -1442.6, z = 31.23, heading = 53.36},
		[27] = {x = 363.46, y = -311.3, z = 46.72, heading = 76.55},
		[28] = {x = 62.4, y = -113.52, z = 57.29, heading = 158.29},
		[29] = {x = -351.98, y = -120.37, z = 39.43, heading = 237.51},
		[32] = {x = 120.22, y = 281.42, z = 109.97, heading = 311.59},
			...
			if result.cb ~= nil then
                ...
                TriggerServerEvent('esx_kr_shops-robbery:UpdateCanRob', id)
                    ...
                    local coords = {
						...
						TriggerServerEvent('esx_phone:send', "police", "Automatisch bericht: Winkeloverval! " .. result.name .. '\'s ', true, coords)
						TriggerServerEvent('esx_kr_shops-robbery:NotifyOwner', "~r~Je winkel wordt overvallen! ~b~(" .. result.name .. ')~r~', id)
					...
					ESX.ShowNotification("~r~Er is niet genoeg politie aanwezig " .. results .. '/' .. Config.RequiredPolices)
				end
			else
				ESX.ShowNotification("~r~Deze winkel is al overvallen, wacht " ..  math.floor((Config.TimeBetweenRobberies - result.time)  / 60) .. ' minuten')
			end
		end)
	end, id)
end
        ...
        Wait(0)
			local playerpos = GetEntityCoords(GetPlayerPed(-1))
				if OnRobbery and GetDistanceBetweenCoords(playerpos.x, playerpos.y, playerpos.z, Coordss.x, Coordss.y, Coordss.z, true) <= 15 then
					...
					TriggerEvent("mt:missiontext", "Breek de kluis:~r~ " .. hp/10 .. "%", 100)

				if hp == 0 then
					OnRobbery = false
					TriggerServerEvent('esx_kr_shops-robbery:GetReward', Id)
					TriggerServerEvent("esx_kr_shops-robbery:NotifyOwner", '~r~De overval op je winkel ~b~(' .. Name ..')~r~ was helaas succesvol!', Id)
					DeleteEntity(Var)
				end
				...
				elseif OnRobbery and GetDistanceBetweenCoords(playerpos.x, playerpos.y, playerpos.z, Coordss.x, Coordss.y, Coordss.z, true) >= 15 then
					OnRobbery = false
					DeleteEntity(Var)
					TriggerServerEvent('esx_kr_shops-robbery:NotifyOwner', "~g~De overval op je winkel ~b~(" .. Name .. ')~g~ is niet geslaagd!', Id)
