		...
		if IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then 
			for i = 1, #CivRepairStation do
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), garageCoords2[1], garageCoords2[2], garageCoords2[3], true ) < 5 then
				 ESX.ShowHelpNotification('Druk op ~INPUT_CONTEXT~ om de reparatie te starten')
...
if insidemarkercheck == true and stage1 == true and stage2 == false and stage3 == false and stage4 == false and stage5 == false and stage6 == false then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~De auto is nog niet klaar voor gebruik ~o~Kom later terug"))
  Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Reperatie status: ~r~25%"))
    Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~De auto wordt gecheckt.."))
end
...
if insidemarkercheck == true and stage1 == false and stage2 == true and stage3 == false and stage4 == false and stage5 == false and stage6 == false then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~De auto is nog niet klaar voor gebruik ~o~Kom later terug"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Reperatie status: ~o~45%"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Bezig met de motoronderdelen.."))
end 
...
if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == true and stage4 == false and stage5 == false and stage6 == false then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~De auto is nog niet klaar voor gebruik ~o~Kom later terug"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Reperatie status: ~o~60%"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Bezig met de versnellingsbak.."))
end 
...
if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == false and stage4 == true and stage5 == false and stage6 == false then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~De auto is nog niet klaar voor gebruik ~o~Kom later terug"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Reperatie status: ~g~85%"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Verversen van de olie.."))
end 
...
if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == false and stage4 == false and stage5 == true and stage6 == false then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~De auto is nog niet klaar voor gebruik ~o~Kom later terug"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Reperatie status: ~g~95%"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Schoonmaken van het interieur.."))
end 
...
if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == false and stage4 == false and stage5 == false and stage6 == true then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~De auto is nog niet klaar voor gebruik ~o~Kom later terug"))
	           Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Reperatie status: ~g~100%"))
	            Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~De auto is weer veilig om mee op straat te rijden!"))
end 
...
if locked == true then
Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~Auto ~r~vergrendeld'))
end

if unlocked == true then
Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~Auto ~g~ontgrendeld'))
end
...
Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~Reparen van de auto start elk moment'))

end

if paynotification == true then

Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~Betaald ~w~voor reparatie'))
end

if stage6 == true then
Draw3DText(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring("~w~De auto is ~g~klaar ~w~om op te halen"))
Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.1, tostring("~w~Druk op ~r~E~w~ om de auto op slot te zetten bij de garage"))
end
...
--	TriggerEvent('chatMessage', 'Bilvasken', {255, 0, 0}, "Du har ikke penge nok, du mangler ^1kr" .. moneyleft .. "") -- danish
	TriggerEvent('chatMessage', 'CivRepair', {255, 0, 0}, "Je hebt niet genoeg geld om een ^3Kleine beurt^0 te betalen, je mist ^1€" .. moneyleft .. "") 
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)
    --[[ 
...
--	TriggerEvent('chatMessage', 'Bilvasken', {255, 0, 0}, "Du har ikke penge nok, du mangler ^1kr" .. moneyleft .. "") -- danish
	TriggerEvent('chatMessage', 'CivRepair', {255, 0, 0}, "Je hebt niet genoeg geld om een ^3Grote beurt^0 te betalen, je mist ^1€" .. moneyleft .. "") 
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)
...
function AutoRepair() -- Credits qalle for assisting with this 
    ...
    local elements = {
        { label = 'Snelle reparatie <font color="red">€2000</font>', value = "repair_fast" },
        { label = 'Normale reparatie <font color="red">€1000</font>', value = "repair_slow" }
    }

    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'civrepair_menu',
        {
            title    = "<font color='lightblue' font-size='15px'>🔧Veenstad Autoreparatie🔧</font>",
            align    = 'center',
            elements = elements
        },
    function(data, menu)
