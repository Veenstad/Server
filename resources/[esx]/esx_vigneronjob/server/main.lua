	...
	if PlayersSelling[source] == true then
		...
		if zone == 'SellFarm' then
			...
			if vine == 0 and jus == 0 and bottle == 0 then
				...
				return
			elseif xPlayer.getInventoryItem('vine').count <= 0 and jus == 0 and bottle == 0 then
				TriggerClientEvent('esx:showNotification', source, _U('no_vin_sale'))
				vine = 0
				return
			elseif xPlayer.getInventoryItem('jus_raisin').count <= 0 and vine == 0 and bottle == 0 then
				TriggerClientEvent('esx:showNotification', source, _U('no_jus_sale'))
				jus = 0
				return
			elseif xPlayer.getInventoryItem('grand_cru').count <= 0 and jus == 0 and vine == 0 then
