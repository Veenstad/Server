webpackJsonp([0], [, , , , , , function(t, e, n) {
    ...
    t.exports = ["op dit moment", ["%s seconden geleden", "%s seconden geleden"],
        ["%s minuten", "%s minuten geleden"],
        ["%s tijd", "%s uur geleden"],
        ["%s dag", "%s dagen geleden"],
        ["%s week", "%s weken geleden"],
        ["%s maand", "%s maanden geleden"],
        ["%s een", "%s jaren geleden"]
    ]
}, function(t, e, n) {
    "use strict";
    var s = n(106),
        ...
        methods: {
            onSelect: function(t) {
                ...
                !0 !== this.ignoreControls && (this.ignoreControls = !0, l.a.CreateModal({
                    ...
                    e.ignoreControls = !1, "Terug" !== t.title && (e.$phoneAPI.callEvent(t.eventName, t.type), e.$router.push({
                        name: "home"
                    }))
                }))
            }
            ...
            delete: function() {
                ...
                if (-1 !== this.id) {
                    ...
                    c.a.CreateModal({
                        ...
                        t.ignoreControls = !1, "Verwijderen" === e.title && (t.$phoneAPI.deleteContact(t.id), history.back())
                    })
                } else history.back()
            }
        }),
        ...
        methods: i()({}, n.i(r.a)(["setMessageRead", "sendMessage", "deleteMessage"]), {
            ...
            onActionMessage: function() {
                ...
                if (!0 === n && (i = [{
                    ...
                    if ("Wissen" === n.title) t.deleteMessage({
                        id: e.id
                    });
            ...
            onRight: function() {
                ...
                !0 !== this.ignoreControls && -1 === this.selectMessage && (this.ignoreControls = !0, h.a.CreateModal({
                    ...
                    "Verstuur GPS Locatie" === e.title && t.sendMessage({
                        phoneNumber: t.phoneNumber,
                        message: "%pos%"
                    }), t.ignoreControls = !1
                }))
            ...
            resetPhone: function(t, e) {
                ...
                if ("Annuler" !== e.title) {
                    ...
                    d.a.CreateModal({
                        ...
                        n.ignoreControls = !1, "WISSEN" === t.title && n.$phoneAPI.deleteALL()
                    })
                }
            }
        }),
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                staticClass: "bar"
            }), t._v(" "), n("label", [t._v("Naam - Voornaam")])]), t._v(" "), n("div", {
                ...
                staticClass: "bar"
            }), t._v(" "), n("label", [t._v("Nummer")])]), t._v(" "), t._m(0), t._v(" "), t._m(1), t._v(" "), t._m(2)])], 1)
        },
        staticRenderFns: [function() {
            var t = this,
                e = t.$createElement,
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                attrs: {
                    title: "Dumpert (" + t.currentSelectPost + ")",
                    backgroundColor: "#5fb047"
                }
            }), t._v(" "), n("div", {
                staticClass: "phone_content"
