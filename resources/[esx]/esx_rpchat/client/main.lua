...
Citizen.CreateThread(function()
	...
	TriggerEvent('chat:addSuggestion', '/admin-chat',   _U('admin_help'),   { { name = _U('generic_argument_name'), help = _U('generic_argument_help') } } )
	TriggerEvent('chat:addSuggestion', '/mod-chat',   _U('mod_help'),   { { name = _U('generic_argument_name'), help = _U('generic_argument_help') } } )
end)
...
AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		...
		TriggerEvent('chat:removeSuggestion', '/admin-chat')
		TriggerEvent('chat:removeSuggestion', '/mod-chat')
	end
end)
