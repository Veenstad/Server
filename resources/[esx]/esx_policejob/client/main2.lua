...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = _U('werend_wear'), value = 'werend_wear' },
		{ label = _U('verkeerkort_wear'), value = 'verkeerkort_wear' },
		{ label = _U('verkeerlang_wear'), value = 'verkeerlang_wear' },
		{ label = _U('ovdpkort_wear'), value = 'ovdpkort_wear' },
		{ label = _U('ovdplang_wear'), value = 'ovdplang_wear' },
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom',
	{
		...
		if
			...
			data.current.value == 'werend_wear' or
