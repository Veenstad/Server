...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = _U('kortnh_wear'), value = 'kortnh_wear' },
		{ label = _U('langnh_wear'), value = 'langnh_wear' },
		{ label = _U('motor_wear'), value = 'motor_wear' },
		{ label = _U('motorhelm_wear'), value = 'motorhelm_wear' },
		{ label = _U('ovdphesje_wear'), value = 'ovdphesje_wear' },
		{ label = _U('petje_wear'), value = 'petje_wear' },
		{ label = _U('polhesje_wear'), value = 'polhesje_wear' },
		{ label = _U('werendnh_wear'), value = 'werendnh_wear' },
		{ label = _U('werendvp_wear'), value = 'werendvp_wear' },
		{ label = _U('dsi_wear'), value = 'dsi_wear' },
		{ label = _U('werendat_wear'), value = 'werendat_wear' },
		{ label = _U('atopen_wear'), value = 'atopen_wear' },
		{ label = _U('atdicht_wear'), value = 'atdicht_wear' },
		{ label = _U('mask_wear'), value = 'mask_wear' },
		{ label = _U('bodyguard_wear'), value = 'bodyguard_wear' }
	}
	...
	if Config.EnableNonFreemodePeds then
		table.insert(elements, {label = 'Koninklijke Marechaussee', value = 'freemode_ped', maleModel = 's_m_y_sheriff_01', femaleModel = 's_f_y_sheriff_01'})
		table.insert(elements, {label = 'Politie Uniform', value = 'freemode_ped', maleModel = 's_m_y_cop_01', femaleModel = 's_f_y_cop_01'})
		table.insert(elements, {label = 'Motor Uniform', value = 'freemode_ped', maleModel = 's_m_y_hwaycop_01', femaleModel = 's_m_y_hwaycop_01'})
		table.insert(elements, {label = 'Arrestatieteam', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
		table.insert(elements, {label = 'Handhaving Uniform', value = 'freemode_ped', maleModel = 's_m_m_security_01', femaleModel = 's_m_m_security_01'})
		table.insert(elements, {label = 'Marine', value = 'freemode_ped', maleModel = 's_m_y_marine_01', femaleModel = 's_m_y_marine_01'})
		table.insert(elements, {label = 'Onopvallende kleding', value = 'freemode_ped', maleModel = 's_m_m_ciasec_01', femaleModel = 's_m_m_ciasec_01'})
		table.insert(elements, {label = 'Politie bureaukleding', value = 'freemode_ped', maleModel = 's_m_y_ranger_01', maleModel = 's_m_y_ranger_01'})
		table.insert(elements, {label = 'Politie Recherche', value = 'freemode_ped', maleModel = 'recherche01', maleModel = 'recherche01'})
	end
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom',
	{
		...
		if
			...
			data.current.value == 'werendnh_wear' or
			data.current.value == 'werendvp_wear' or
			data.current.value == 'werendat_wear' or
			data.current.value == 'verkeerkort_wear' or
			data.current.value == 'verkeerlang_wear' or
			data.current.value == 'ovdphesje_wear' or
			data.current.value == 'polhesje_wear' or
			data.current.value == 'kortnh_wear' or
			data.current.value == 'langnh_wear' or
			data.current.value == 'petje_wear' or
			data.current.value == 'mask_wear' or
			data.current.value == 'atopen_wear' or
			data.current.value == 'atdicht_wear' or
			data.current.value == 'motor_wear' or
			data.current.value == 'motorhelm_wear' or
			data.current.value == 'bodyguard_wear' or
			data.current.value == 'dsi_wear'
		then
	...
	'default', GetCurrentResourceName(), 'police_actions',
	{
		...
		if data.current.value == 'citizen_interaction' then
			local elements = {
				...
				{label = "Taakstraf geven",	value = 'communityservice'}
			}
		...
		elseif data.current.value == 'object_spawner' then
			...
			'default', GetCurrentResourceName(), 'citizen_interaction',
			{
				...
				if model == 'prop_roadcone01a' then
					z = z - 1.0
				end
