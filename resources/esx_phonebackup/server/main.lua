...
AddEventHandler('esx_phone:startCall', function(number)
	...
	if foundPlayer ~= false then
		...
		TriggerEvent('DiscordBot:ToDiscord', 'https://discordapp.com/api/webhooks/563098406579601438/xsSudVrvZ6NtcNnLHdRE2jLSGuq9fFVh23WauANc_cbGaRNs2nwPoipjtfRC3TphT-64', 'Telefoon: ' .. xPlayer.name .. ' [ID: ' .. source .. ']', '**CALL: ' .. xPlayer.name .. '@' .. foundPlayer.name , 'https://www.frisblikopener.be/sites/frisblikopener/files/styles/colorbox_large__1200x1200/public/blog28.png?itok=E9SEWkMp', false, Source, TTS) --Sending the message to discord
	end
end)
...
AddEventHandler('esx_phone:send', function(phoneNumber, message, anon, position)
	...
	TriggerEvent('DiscordBot:ToDiscord', 'https://discordapp.com/api/webhooks/563098406579601438/xsSudVrvZ6NtcNnLHdRE2jLSGuq9fFVh23WauANc_cbGaRNs2nwPoipjtfRC3TphT-64', 'Telefoon: ' .. xPlayer.name .. ' [ID: ' .. source .. ']', '**SMS: ' .. xPlayer.name .. '@' .. phoneNumber .. ' => **' ..  message, 'https://www.frisblikopener.be/sites/frisblikopener/files/styles/colorbox_large__1200x1200/public/blog28.png?itok=E9SEWkMp', false, Source, TTS) --Sending the message to discord
end)
