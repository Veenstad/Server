...
local dna 				= {}
local weapons = {
	[-1569615261] = {name = 'WEAPON_UNARMED', hash = 2725352035, text = 'Vuist'},
	[-1716189206] = {name = 'WEAPON_KNIFE', hash = 2578778090, text = 'Mes'},
	[1737195953]  = {name = 'WEAPON_NIGHTSTICK', hash = 1737195953, text = 'knuppel'},
	[2508868239]  = {name = 'WEAPON_BAT', hash = 2508868239, text = 'Honkbalknuppel'},
	[1317494643]  = {name = 'WEAPON_HAMMER', hash = 1317494643, text = 'Hamer'},
	[1141786504]  = {name = 'WEAPON_GOLFCLUB', hash =1141786504, text = 'Golfclub'},
	[2227010557]  = {name = 'WEAPON_CROWBAR', hash =2227010557, text = 'Koevoet'},
	[2460120199]  = {name = 'WEAPON_DAGGER', hash =2460120199, text = 'Dolk'},
	[3638508604]  = {name = 'WEAPON_KNUCKLE', hash =3638508604, text = 'boksbeugels'},
	[4191993645]  = {name = 'WEAPON_HATCHET', hash =4191993645, text = 'bijl'},
	[3713923289]  = {name = 'WEAPON_MACHETE', hash =3713923289, text = 'kapmes'},
	[3756226112]  = {name = 'WEAPON_SWITCHBLADE', hash =3756226112, text = 'zakmes'},
	[3441901897]  = {name = 'WEAPON_BATTLEAXE', hash =3441901897, text = 'bijl'},
	[2484171525]  = {name = 'WEAPON_POOLCUE', hash =2484171525, text = 'biljartkeu'},
	[419712736]   = {name = 'WEAPON_WRENCH', hash =419712736, text = 'moersleutel'}
}
	...
	if dna.p == nil then
		...
		if IsPedFatallyInjured(ped) then
			...
			if weapon ~= nil then
				...
				ESX.ShowNotification('Neem DNA-monsters af van een plaats delict..')
			else
				ESX.ShowNotification('Geen sporen van DNA gevonden..')
			end
		else
			dna = {k = nil, d = nil, w = nil, p = GetPlayerServerId(player)}
			ESX.ShowNotification('DNA monster afgenomen..')
		end
	else
		ESX.ShowNotification('Je hebt al een DNA monster bij je, voer het eerst in..')
	end
end)
