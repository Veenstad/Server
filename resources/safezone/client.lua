...
local zones = {
	...
	{ ['x'] = 184.76, ['y'] = -959.57, ['z'] = 29.29 },
	{ ['x'] = 443.47, ['y'] = -982.94, ['z'] = 30.69 },
	{ ['x'] = 337.23, ['y'] = -587.97, ['z'] = 43.29 }
}
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if dist <= 60.0 then  ------------------------------------------------------------------------------ Here you can change the RADIUS of the Safe Zone. Remember, whatever you put here will DOUBLE because 
			if not notifIn then																		  -- it is a sphere. So 50 will actually result in a diameter of 100. I assume it is meters. No clue to be honest.
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>Je bent nu in de SafeZone</b>",
					type = "success",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
			...
			if not notifOut then
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>Je hebt de SafeZone verlaten.</b>",
					type = "error",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
		...
		DisableControlAction(0, 140, true) -- Disable R melee attack
			if IsDisabledControlJustPressed(2, 37) then --if Tab is pressed, send error message
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>Je mag geen wapens in de safezone gebruiken</b>",
					type = "error",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
			...
			if IsDisabledControlJustPressed(0, 106) then --if LeftClick is pressed, send error message
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>Dit is niet mogelijk in de Safe Zone</b>",
					type = "error",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
