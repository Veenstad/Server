$(document).ready(function(){
  ...
  var goodAnswer = [];
  var questionUsed = [];
  var nbQuestionToAnswer = 15; // don't forget to change the progress bar max value in html
  var nbAnswerNeeded = 12; // out of nbQuestionToAnswer
  ...
  $(".btnQuestion").click(function(){
      $.post('http://vsrp_vragen/question', JSON.stringify({}));
  });
  $(".btnClose").click(function(){
      $.post('http://vsrp_vragen/close', JSON.stringify({}));
  });
  $(".btnKick").click(function(){
      $.post('http://vsrp_vragen/kick', JSON.stringify({}));
  });
