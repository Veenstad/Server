...
Config = {
	...
	notification = 2,				-- 0 = Disable | 1 = LockSystem notification | 2 = chatMessage notification
	...
	randomMsg =	{
			"Je hebt de sleutels in het dashboardkastje gevonden",
			"De sleutels waren er al. Je nam ze mee",
			"Je hebt de sleutels in het dashboard gevonden",
	}
}