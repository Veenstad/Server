$(document).ready(function(){
  ...
  var goodAnswer = [];
  var questionUsed = [];
  var nbQuestionToAnswer = 2; // don't forget to change the progress bar max value in html
  var nbAnswerNeeded = 2; // out of nbQuestionToAnswer
  var nbPossibleQuestions = 2; //number of questions in database questions.js
