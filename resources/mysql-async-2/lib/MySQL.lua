...
function MySQL.Sync.execute(query, params)
    ...
    return exports['mysql-async-2']:mysql_sync_execute(query, safeParameters(params))
end
...
function MySQL.Sync.fetchAll(query, params)
    ...
    return exports['mysql-async-2']:mysql_sync_fetch_all(query, safeParameters(params))
end
...
function MySQL.Sync.fetchScalar(query, params)
    ...
    return exports['mysql-async-2']:mysql_sync_fetch_scalar(query, safeParameters(params))
end
...
function MySQL.Sync.insert(query, params)
    ...
    return exports['mysql-async-2']:mysql_sync_insert(query, safeParameters(params))
end
...
function MySQL.Sync.transaction(querys, params)
    ...
    return exports['mysql-async-2']:mysql_sync_transaction(querys, safeParameters(params))
end
...
function MySQL.Async.execute(query, params, func)
    ...
    exports['mysql-async-2']:mysql_execute(query, safeParameters(params), safeCallback(func))
end
...
function MySQL.Async.fetchAll(query, params, func)
    ...
    exports['mysql-async-2']:mysql_fetch_all(query, safeParameters(params), safeCallback(func))
end
...
function MySQL.Async.fetchScalar(query, params, func)
    ...
    exports['mysql-async-2']:mysql_fetch_scalar(query, safeParameters(params), safeCallback(func))
end
...
function MySQL.Async.insert(query, params, func)
    ...
    exports['mysql-async-2']:mysql_insert(query, safeParameters(params), safeCallback(func))
end
...
function MySQL.Async.transaction(querys, params, func)
    ...
    return exports['mysql-async-2']:mysql_transaction(querys, safeParameters(params), safeCallback(func))
end
...
function MySQL.Threaded.execute(query, params)
    ...
    return exports['mysql-async-2']:mysql_threaded_execute(query, safeParameters(params))
end
...
function MySQL.Threaded.fetchAll(query, params)
    ...
    return exports['mysql-async-2']:mysql_threaded_fetch_all(query, safeParameters(params))
end
...
function MySQL.Threaded.fetchScalar(query, params)
    ...
    return exports['mysql-async-2']:mysql_threaded_fetch_scalar(query, safeParameters(params))
end
...
function MySQL.Threaded.insert(query, params)
    ...
    return exports['mysql-async-2']:mysql_threaded_insert(query, safeParameters(params))
end
