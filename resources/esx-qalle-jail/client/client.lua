...
function JailLogin()
	...
	ESX.ShowNotification("De laatste keer dat je ging slapen zat je nog in de gevangenis, daarom ben je nu teruggezet!")
...
function UnJail()
	...
	ESX.ShowNotification("Je bent vrijgelaten, doe rustig aan de volgende keer! Succes!")
end
...
function InJail()
	...
	Citizen.CreateThread(function()
		...
		while jailTime > 0 do
			...
			ESX.ShowNotification("Je bent nog voor " .. jailTime .. " minuten in de gevangenis!")
