...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(1000 * 60) -- every minute
			...
			SetConvarServerInfo('Wachtrij', tostring(#waiting))
	end
end)

RegisterCommand("wachtrij", function(source, args, rawCommand)
	print(#waiting)
	TriggerClientEvent("chatMessage", "Wachtrij: ", {255, 255, 255}, #waiting)
end)
