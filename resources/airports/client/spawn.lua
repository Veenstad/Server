...
AddEventHandler("airports:moneyInvalid", function()
	...
	AddTextComponentSubstringPlayerName("Je hebt niet genoeg geld om een ticket te kopen.\n")
	SetNotificationMessage("CHAR_BLOCKED", "CHAR_BLOCKED", true, 4, "Luchthaven", "", "Je hebt niet genoeg geld om een ticket te kopen.\n")
