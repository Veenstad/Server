...
AddEventHandler('drugsInProgress', function(street1, street2, sex)
	...
	TriggerClientEvent("outlawNotify", -1, "~r~Melding drugsverkoop door een ~w~"..sex.." ~r~Vlakbij ~w~"..street1.."~r~ a ~w~"..street2)
end)
...
AddEventHandler('drugsInProgressS1', function(street1, sex)
	...
	TriggerClientEvent("outlawNotify", -1, "~r~Melding drugsverkoop door een ~w~"..sex.." ~r~Vlakbij ~w~"..street1)
end)
