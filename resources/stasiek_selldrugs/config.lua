Config                            = {}
Config.Locale = 'nl' -- your language, It would be nice if you send me your translation on fivem forum
...
Config.SellMeth = false	-- if true, players can sell meth
Config.SellCoke = false	-- if true, players can sell coke
Config.SellOpiu = true	-- if true, players can sell opium
Config.WeedPrice = 100	-- sell price for single, not pooch (black money)
...
Config.OpiuPrice = 350	-- sell price for single, not pooch (black money)
